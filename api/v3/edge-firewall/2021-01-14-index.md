...
| Settings *(mandatory)* | **name** (string): mandatory field that defines the name of the Edge Firewall rule set.<br /><br />**waf_enabled**<br /><br />**is_active**<br /><br />**edge_functions_enabled**<br /><br />**last_modified**<br /><br />**domains**<br /><br />**last_editor**<br /><br />**network_protection_enabled** | body | json |
